...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/data/room.oel", __ASSET__assets_data_room_oel);
		type.set ("assets/data/room.oel", AssetType.TEXT);
		className.set ("assets/data/roomFantasy.oel", __ASSET__assets_data_roomfantasy_oel);
		type.set ("assets/data/roomFantasy.oel", AssetType.TEXT);
		className.set ("assets/data/snow-day.oep", __ASSET__assets_data_snow_day_oep);
...
@:keep @:bind #if display private #end class __ASSET__assets_data_room_oel extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_data_roomfantasy_oel extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_data_snow_day_oep extends flash.utils.ByteArray { }
...
//@:file("assets/data/room.oel") class __ASSET__assets_data_room_oel extends lime.utils.ByteArray {}
//@:file("assets/data/roomFantasy.oel") class __ASSET__assets_data_roomfantasy_oel extends lime.utils.ByteArray {}
//@:file("assets/data/snow-day.oep") class __ASSET__assets_data_snow_day_oep extends lime.utils.ByteArray {}
