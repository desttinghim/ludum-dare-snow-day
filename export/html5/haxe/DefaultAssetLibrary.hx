...
@:keep @:bind #if display private #end class __ASSET__assets_data_room_oel extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_data_snow_day_oep extends null { }
...
//@:sound("C:/HaxeToolkit/haxe/lib/flixel/3,3,6/assets/sounds/beep.ogg") class __ASSET__assets_sounds_beep_ogg extends openfl.media.Sound {}
//@:sound("C:/HaxeToolkit/haxe/lib/flixel/3,3,6/assets/sounds/flixel.ogg") class __ASSET__assets_sounds_flixel_ogg extends openfl.media.Sound {}
//
//
